...
class GoldenEye(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down BLADE OF DEATH")
...
def usage():
    ...
    print('-----------------------------------------------------------------------------------------------------------')
    print()
    print('BLADEOFDEATH_BANNER')
    print()
    print(' USAGE: python3 blade.py <URL> -w 100 -d')
    print()
    print(' OPTIONS:')
    ...
    print('\t -m, --method\t\tHTTP Method \'get\' or \'post\'  or \'random\'\t\t(default: get)')
    ...
    print('\t -h, --help\t\tfor help to run program')
    print()
    print('-----------------------------------------------------------------------------------------------------------')
